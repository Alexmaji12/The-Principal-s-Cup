    ...
    loginButton.addEventListener("click", (e) => {
      ...
      auth.signInWithEmailAndPassword(email, password).then((userCredential) => {
        ...
        document.getElementById('loadingPopup').style.display = 'none';
            ...
            if (role === "athlete") {
              window.location.replace = "/login/athlete-dashboard/template/index.html"; // Athlete dashboard
          } else if (role === "team") {
              window.location.replace = "/login/scout-dashboard/template/index.html"; // Team dashboard
          } else {
